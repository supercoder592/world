...
| 📷 監視器（台灣） | 🇹🇼 台灣 | 國道：高速公路局開放資料（免金鑰）。省道 / 22 縣市：[交通部 TDX](https://tdx.transportdata.tw/)（匿名可試用，免費金鑰解除每日次數限制）。另可自行新增任何公開影像網址（JPG 快照 / MJPEG / HLS / 網頁連結） | 免金鑰（TDX 金鑰選填） |
| 📷 監視器（國際） | 🇺🇸🇬🇧🇨🇦🇫🇮🇦🇺🇪🇪🇩🇪 11 個來源 | 美國奧斯汀 / 加州 Caltrans（全部 12 轄區）/ 德州 TxDOT（全部 25 轄區）、英國倫敦 TfL JamCam、加拿大安大略 511 / 卑詩省 DriveBC / 卡加利、芬蘭 Fintraffic、澳洲新南威爾斯、愛沙尼亞塔林、德國瓦倫多夫 — 皆各國政府開放資料，每個來源盡量拉取全部而非部分城市，開站自動載入 | 免金鑰 |
| 🌊 海象浮標 | 🇹🇼 台灣 | [中央氣象署開放資料](https://opendata.cwa.gov.tw/) 海象監測浮標（O-B0075-001）：浪高、波向、週期、海溫、風速、潮位 | 免費授權碼（自行註冊，僅存於瀏覽器 localStorage） |
| 🚆 鐵路車站 | 🇹🇼 台灣 | [交通部 TDX](https://tdx.transportdata.tw/) 台鐵／高鐵車站位置；點台鐵站可看即時到離站看板（誤點分鐘數） | 免金鑰（匿名可用，TDX 金鑰選填解除額度限制） |

> 監視器沒有全球統一資料庫，只能逐一串接各國格式互異的政府開放資料；已涵蓋台灣＋10 個國家/地區，之後可視需要再擴充其他國家。海象浮標目前限台灣。
>
> 鐵路圖層誠實說明限制：TDX 目前**沒有**列車即時 GPS 位置（不像公車有即時定位），只做到「車站」層級——台鐵有即時到離站看板，高鐵 TDX 沒有對應 API，只放站點位置＋連去官網查詢，不會假裝有列車在地圖上跑。
...
- 海象浮標每 10 分鐘自動更新最新觀測
- 頂欄「🏠 台灣」按鈕隨時飛回台灣視野
- 頂欄「🔍 搜尋」：地點／城市（OpenStreetMap Nominatim 免金鑰地理編碼）與已載入的監視器名稱一起搜，點結果直接飛過去
- 夜間偵探風深色介面，支援手機瀏覽
...
**完全不用金鑰就有**：飛機、國道 CCTV、地震、頭頂衛星、鐵路車站、地圖底圖。
...
- [ ] 氣象署潮位站觀測
- [x] 其他國家的公開監視器（美/英/加/澳/芬蘭/愛沙尼亞/德國，11 個來源）
- [x] 鐵路車站圖層（台鐵／高鐵，TDX）
- [ ] 更多國家的公開監視器
- [ ] 事件回放與航跡歷史
